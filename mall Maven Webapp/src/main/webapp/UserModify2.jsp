...
<tbody><tr><td class="nav" align="left" nowrap="nowrap" width="90%">亿期商城 &#187; 注册</td>
<td align="right" width="10%">&nbsp;<a href="#bottom"><img src="images/arrow_dw.gif" align="absmiddle" border="0"></a></td>        
</tr></tbody></table><br>
<form method="post" name="register" action="userModify.action" onSubmit="this.regsubmit.disabled=true;">
...
<tr>
<td class="altbg1" width="21%">用户id:</td>
<td class="altbg2"><input name="userId" size="25" maxlength="25" type="text" readonly="readonly" value="${sessionScope.user.userId}"> </td>
</tr>
<tr>
<td class="altbg1" width="21%">姓名:</td>
<td class="altbg2"><input name="name" size="25" maxlength="25" type="text"  value=""> </td>
</tr>
<tr>
<td class="altbg1">电话:</td>
<td class="altbg2"><input name="tel" type="text" id="phone" size="25" value="${sessionScope.user.tel}"></td>
</tr>
...
<a target="_blank" href="http://www.thinkpadclub.com.cn/"><u>亿期商城</u></a><br>
服务热线:010-58052712
