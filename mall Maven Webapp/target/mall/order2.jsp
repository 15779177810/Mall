                    ...
                    <td class="info">
                        <c:choose>
                            ...
                            <c:when test="${order.state == 2}">
                                <!-- <a href="toComment.action?orderId=${order.order_id}" class="label label-success" role="button">
                                    评论
                                </a> -->
                                <a  type="button" class="label label-success" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">
                                    评论
                                </a>
                            </c:when>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h2 class="modal-title text-center" style="color:green" id="exampleModalLabel">欢迎评论</h2>
                    </div>

                    <div class="modal-body">
                        <form action="toComment.action?orderId=${order.order_id}" method="GET">
                            <div class="alert alert-success" role="alert">
                                <p class="text-center">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" id="message-text" rows="4" placeholder="请输入评论"></textarea>
                            </div>
                        </form>
                    </div>
